...
X_train, X_test, y_train, y_test = train_test_split(trainX, y, test_size=0.3,random_state=7)
...
for i in (500, 800, 1200,1500,2000,3000,4000,5000):
  for j in (2,4,5,6,7,8,9,10,12,15,18):
    rf1 = RandomForestClassifier(n_estimators=i,max_depth=j,min_samples_split=2,min_samples_leaf=2)
    rf1.fit(X_train_res, y_train_res.ravel())
    y_pred = rf1.predict(X_test)
    print("{} for {} estimators and {} depth with F1 :{}".format(accuracy_score(y_test,y_pred),i,j,f1_score(y_test,y_pred)))
